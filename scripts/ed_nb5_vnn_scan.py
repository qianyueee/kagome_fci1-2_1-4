"""Nb=5 V_nn scan on 72-site Kagome disk: V_nn from 0 to 2, 11 points, V_nnn=0."""
...
npz_out = f'kagome_disk_nb{Nb}_vnn_scan_0to2.npz'
...
plt.tight_layout()
out = f'kagome_disk_nb{Nb}_vnn_scan_0to2.png'
