"""Nb=5 scan, V_nn = 3.0, 3.2, 3.4, 3.6, 3.8 (5 points step 0.2),
V_nnn = 1.5 * V_nn.  Discretized trap baked into hamiltonian.py.
"""
...
V_nn_list = np.linspace(3.0, 3.8, 5)
V_nnn_list = V_nn_list * 1.5
tag = 'vnnn_1p5xvnn_vnn_3to3p8_disc'
