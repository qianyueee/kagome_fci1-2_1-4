"""Nb=5 V_nn extension scan: V_nn from 4.2 to 6.0, 10 points (step 0.2),
V_nnn=0. Designed to be merged with the 0-2 and 2.2-4 scans for a 0-6 plot.
"""
...
npz_out = f'kagome_disk_nb{Nb}_vnn_scan_4p2to6.npz'
...
ax.set_title(f'Nb={Nb} spectrum vs $V_{{nn}}$  '
             f'(extension 4.2 to 6.0, {len(V_nn_list)} pts, lowest {n_show})')
ax.legend(loc='upper left', fontsize=9, ncol=2, framealpha=0.9)
ax.grid(True, alpha=0.3)

plt.tight_layout()
out = f'kagome_disk_nb{Nb}_vnn_scan_4p2to6.png'
