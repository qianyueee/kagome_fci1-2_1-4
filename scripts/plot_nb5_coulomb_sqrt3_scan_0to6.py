"""Merge Nb=5 Coulomb-like (V_nnn=V_nn/sqrt(3)) 0-4 + 4.2-6 scans into a 0-6 plot."""
...
segments = [
    f'kagome_disk_nb{Nb}_coulomb_vnnn_sqrt3_vnn_0to4.npz',
    f'kagome_disk_nb{Nb}_coulomb_vnnn_sqrt3_vnn_4p2to6.npz',
]
...
plt.tight_layout()
out = f'kagome_disk_nb{Nb}_coulomb_vnnn_sqrt3_vnn_0to6.png'
plt.savefig(out, dpi=180, bbox_inches='tight')
print(f"Saved: {out}")

npz_out = f'kagome_disk_nb{Nb}_coulomb_vnnn_sqrt3_vnn_0to6.npz'
