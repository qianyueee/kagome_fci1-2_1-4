"""Nb=5 V_nnn = V_nn scan (ratio 1.0, strongest NNN we have tried):
V_nn from 2 to 6, 21 points (step 0.2), lowest 10 states per (L sector, V) point.
"""
...
ax.set_xlabel(r'$V_{nn}$  ($V_{nnn}=V_{nn}$)')
ax.set_ylabel('E')
