"""Nb=5 Coulomb-like ext scan: V_nn from 2.2 to 4.0, 10 points (step 0.2),
V_nnn = V_nn / 2. To be merged with the 0-2 coulomb scan into a 0-4 plot.
"""
...
V_nnn_list = V_nn_list / 2.0
tag = 'coulomb_vnnn_half_vnn_2p2to4'
...
ax.set_title(f'Nb={Nb} spectrum vs Coulomb-like V  '
             f'(extension 2.2 to 4, {len(V_nn_list)} pts, lowest {n_show})')
