"""Nb=5 scan, V_nn from 4 to 6 (11 points step 0.2), V_nnn = 1.5 * V_nn.
Trap uses discretized form round(9 r_half_sq) * V_trap/9 (now baked into
ModelParams/hamiltonian.py).
"""
...
tag = 'vnnn_1p5xvnn_vnn_4to6_disc'
