...
out_npz = 'data/nb5/kagome_density_nb5_vnn7_vnnn7_trap2x.npz'
...
plt.tight_layout()
out_sp = f'{out_dir}/spectrum_vnn7_vnnn7_trap2x_n{n_keep}.png'
...
plt.tight_layout()
out_d = f'{out_dir}/density_vnn7_vnnn7_trap2x.png'
