"""Nb=5 Coulomb-like scan on 72-site Kagome disk:
V_nnn = V_nn / 2, V_nn from 0 to 2, 11 points (interaction ratio matches 1/r at NNN/NN).
"""
...
tag = 'coulomb_vnnn_half_vnn_0to2'
...
ax.set_title(f'Nb={Nb} spectrum vs Coulomb-like V  '
             f'(0 to 2, {len(V_nn_list)} pts, lowest {n_show})')
