...
out_npz = 'data/nb5/kagome_density_nb5_vnn10_vnnn10_trap2x.npz'
...
plt.tight_layout()
out_sp = f'{out_dir}/spectrum_vnn10_vnnn10_trap2x_n{n_keep}.png'
...
plt.tight_layout()
out_d = f'{out_dir}/density_vnn10_vnnn10_trap2x.png'
